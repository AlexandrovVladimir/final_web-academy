...
function TopSlider() {
    var slides = document.querySelector('.top-slider__items');
    var slidesCount = document.querySelectorAll('.item-content');
...
function SurfBoardsSlider() {
    var slides = document.querySelector('.surfboards-slider__content');
    var slidesCount = document.querySelectorAll('.surfboards-slider__item');
    var leftArrow = document.querySelector('.surfboards-slider__arrows-left');
    var rightArrow = document.querySelector('.surfboards-slider__arrows-right');
...
var surfBoardSlider = new SurfBoardsSlider();

var control = document.querySelector('.burger-block');
